...
var ball = {
	...
	maxSpeed : { x: 100, y: 100}, // to govern max speed of the ball
	...
	computePath : function(){
		...
		var newBallX = ball.movementDirection.x * 2,
		newBallY = ball.movementDirection.y * 2;
...
var ball2 = {
	...
	computePath : function(){
		...
		var newBallX = ball2.movementDirection.x * 2,
			newBallY = ball2.movementDirection.y * 2;
